...
const val LONG_TEXT: String =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ultrices eros in cursus turpis massa tincidunt dui. Venenatis cras sed felis eget velit. Tincidunt praesent semper feugiat nibh sed pulvinar proin gravida hendrerit. Arcu bibendum at varius vel pharetra. Imperdiet sed euismod nisi porta lorem mollis. Phasellus vestibulum lorem sed risus ultricies tristique nulla aliquet. Interdum varius sit amet mattis vulputate enim nulla aliquet. Amet massa vitae tortor condimentum lacinia. Quam id leo in vitae turpis massa sed elementum. Pellentesque eu tincidunt tortor aliquam nulla facilisi cras fermentum odio.\n" +
            "\n" +
            "Posuere ac ut consequat semper viverra nam. Est ante in nibh mauris cursus mattis molestie. Tortor consequat id porta nibh venenatis cras sed. Ut placerat orci nulla pellentesque dignissim enim sit. Luctus accumsan tortor posuere ac ut. Consequat interdum varius sit amet. Dui sapien eget mi proin sed libero enim sed faucibus. Ut consequat semper viverra nam. A pellentesque sit amet porttitor eget dolor. Massa sed elementum tempus egestas sed sed risus pretium quam. Quis risus sed vulputate odio ut enim. Tortor id aliquet lectus proin nibh. Orci porta non pulvinar neque laoreet suspendisse interdum. Ultrices tincidunt arcu non sodales neque sodales ut etiam sit. Eget lorem dolor sed viverra ipsum. Ultrices eros in cursus turpis massa. Nunc pulvinar sapien et ligula ullamcorper malesuada proin libero nunc. Pellentesque habitant morbi tristique senectus et netus et.\n" +
            "\n" +
...
val NEWS_LIST = listOf<Pair<String, String>>(
    Pair(
        "1 Сентября 2022 в 12:01",
        "Никого не смущает огромная популяция кенгуру, которых в австралии почти столько же, сколько и людей, проживающих там? "
    ),
    Pair(
        "2 Сентября 2022 в 12:01",
        "DICE подтвердила, что крупное обновление 3.2 для Battlefield 2042 появится на следующей неделе. "
    ),
    Pair(
        "3 Сентября 2022 в 12:01",
        "Журналисты из DSOGaming проанализировали очередную видеоигровую новинку. На этот раз их длинные руки дотянулись до экшена Forspoken от Square Enix.  "
    ),
    Pair(
        "4 Сентября 2022 в 12:01",
        "Студия Arkane представила трейлер Redfall, посвящённый бонусам за предзаказ. "
    ),
    Pair(
        "5 Сентября 2022 в 12:01",
        "На этой неделе в Steam вновь стартовало несколько распродаж, а также начались бесплатные выходные в Scarlet Nexus"
    ),
    Pair(
        "6 Сентября 2022 в 12:01",
        "Обновленная The Witcher 3 доступна уже давно, однако CD Projekt RED продолжает выпускать различные трейлеры, чтобы еще лучше прорекламировать тайтл."
    ),
    Pair(
        "7 Сентября 2022 в 12:01",
